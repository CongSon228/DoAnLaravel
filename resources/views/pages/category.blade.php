        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <a href="{{ URL('category/'.$cat->id) }}">
                    <h1 style="font-size:50px;color:red;">{{ $cat->catName }}</h1>
                </a>
                <p>------------------------------------------------------------------------------------------
                </p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 gtco-heading text-center">
                        <a href="{{ URL('type/'.$typ->id) }}">
                            <h2 style="color:green;">{{ $typ->typeName }}</h2>
                        </a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="owl-carousel owl-carousel-carousel">
                            ...
                            <div class="item">
                                <div class="gtco-item">
                                    <a href="#"><img src="{{asset('images/'.$pro->image)}}" alt=""
                                            class="img-responsive"></a>
                                    <h2 style="height:60px;"><a href="#">{{ $pro->proName }}</h2></a>
                                    <form>
                                        @csrf
